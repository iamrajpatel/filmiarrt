    ...
    <div class="container p-2" >
        <div class="row">
            ...
            <div class="row" style="margin: 10px 0">
                <div class="col-md-12">
                <h1 class="text-center">Our Platinum Sponsors</h1>
                </div>
                <div class="col-sm center p-2">
                    <div class="text-center">
                      <img src="Assets/images/pepsi_logo_2014.svg.png" alt="">   
                    </div>
            ...
            <h1 class="text-center">Our Gold Sponsors</h1>
            </div>
                <div class="col-sm center p-2">
                    <div class="text-center">
                       <img src="Assets/images/pepsi_logo_2014.svg.png" alt="">
            ...
            <div class="row" style="margin: 10px 0">
                 <div class="col-md-12">
                 <h1 class="text-center" style="padding:10px 0">Our Silver Sponsors</h1>
                 </div>
                <div class="col-sm center p-2">
                    <div class="text-center">
                       <img src="Assets/images/pepsi_logo_2014.svg.png" alt="">
